			...
			<div class="category fl <?php if($show_nav!=1) echo 'cat1'; ?>"> <!-- 非首页，需要添加cat1类 -->
				...
				<div class="cat_bd <?php if($show_nav!=1) echo 'none'; ?>">
					<?php if(is_array($catData)): $i = 0; $__LIST__ = $catData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="cat <?php if($key == 0): ?>item1<?php endif; ?>">
						<h3><a href="<?php echo U('Home/Search/search',array('cid'=>$vo['id']));?>"><?php echo ($vo["cat_name"]); ?></a> <b></b></h3>
						<div class="cat_detail">
							<?php if(is_array($vo['children'])): $i = 0; $__LIST__ = $vo['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><dl class="<?php if($key == 1): ?>dl_1st<?php endif; ?>">
									<dt><a href="<?php echo U('Home/Search/search',array('cid'=>$vo1['id']));?>"><?php echo ($vo1["cat_name"]); ?></a></dt>
									...
									<a href="<?php echo U('Home/Search/search',array('cid'=>$vo2['id']));?>"><?php echo ($vo2["cat_name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
								</dd>
...
<div class="guide w1210 bc mt15">
    ...
    <div class="guide_content fl">
        ...
        <div class="guide_wrap">
            ...
            <div class="crazy">
                <ul>
                    <?php if(is_array($crazygoods)): $i = 0; $__LIST__ = $crazygoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                            <dl>
                                <dt><a href="<?php echo U('Home/Index/goods',array('goods_id'=>$vo['id']),false);?>"><?php showImage($vo['sm_logo'])?></a></dt>
                                <dd><a href="<?php echo U('Home/Index/goods',array('goods_id'=>$vo['id']),false);?>"><?php echo ($vo["goods_name"]); ?></a></dd>
                                <dd><span>售价：</span><strong> ￥<?php echo ($vo["promote_price"]); ?>元</strong></dd>
                            </dl>
                ...
                <ul>
                    <?php if(is_array($hotgoods)): $i = 0; $__LIST__ = $hotgoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                            <dl>
                                <dt><a href="<?php echo U('Home/Index/goods',array('goods_id'=>$vo['id']),false);?>"><?php showImage($vo['sm_logo'])?></a></dt>
                                <dd><a href="<?php echo U('Home/Index/goods',array('goods_id'=>$vo['id']),false);?>"><?php echo ($vo["goods_name"]); ?></a></dd>
                                <dd><span>售价：</span><strong> ￥<?php echo ($vo["shop_price"]); ?>元</strong></dd>
                            </dl>
                        </li><?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </div>
