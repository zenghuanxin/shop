...
<div id="main-div">
    <div id="menu-list">
        ...
        <ul id="menu-ul">
            <?php if(is_array($btn)): $i = 0; $__LIST__ = $btn;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="explode" key="02_cat_and_goods" name="menu">
                <?php echo ($vo['pri_name']); ?>
                    <ul>
                        <?php if(is_array($vo['children'])): $i = 0; $__LIST__ = $vo['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><li class="menu-item"><a href="<?php echo U($vo1['module_name'].'/'.$vo1['controller_name'].'/'.$vo1['action_name']);?>" target="main-frame"><?php echo ($vo1["pri_name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
            ...
            <!--商品管理-->
                <!--<ul>-->
                    ...
                    <!--&lt;!&ndash;<li class="menu-item"><a href="<?php echo U('Goods/goodsAdd');?>" target="main-frame">添加新商品</a></li>&ndash;&gt;-->
                    <!--<li class="menu-item"><a href="<?php echo U('Category/lst');?>" target="main-frame">商品分类</a></li>-->
                    <!--&lt;!&ndash;<li class="menu-item"><a href="brandList.html" target="main-frame">商品品牌</a></li>&ndash;&gt;-->
                    <!--&lt;!&ndash;<li class="menu-item"><a href="goodsTrash.html" target="main-frame">商品回收站</a></li>&ndash;&gt;-->
                <!--</ul>-->
            <!--</li>-->
