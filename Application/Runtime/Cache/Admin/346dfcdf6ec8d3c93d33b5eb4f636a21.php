    ...
    <div id="tabbody-div">
        <form name="main_form" method="POST" action="/index.php/Admin/Goods/add.html" enctype="multipart/form-data">
            <table class="table-content" cellspacing="1" cellpadding="3" width="100%">
                ...
                <tr>
                    <td class="label"><input  name="is_promote" type="checkbox"value="1" onclick="if($(this).attr('checked')) $('.promote_price').removeAttr('disabled'); else $('.promote_price').attr('disabled','disabled');"/>促销价：</td>
                    <td>
